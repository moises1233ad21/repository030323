...
@RestController
@RequestMapping("tienda/api/")//endpoint
public class ControladorProducto {

    //el Controlador necesita llamar el Servicio.
    ...
    public ResponseEntity<?> buscarTodosProductos(){
        try {
            ...
            return ResponseEntity
                    .status(HttpStatus.BAD_REQUEST)
                        .body("Error buscando los producto");
        }
    }

    @GetMapping("/{id}") //desde aqui llega el dato
